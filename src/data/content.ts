...
export const getContent = (t: Translator) => ({
  ...
  sampleBooking: {
    ...
    email: t("sampleBooking.email"),
    businessType: t("sampleBooking.businessType"),
    address: t("sampleBooking.address"),
    city: t("sampleBooking.city"),
    businessSizePlaceholder: t("sampleBooking.businessSizePlaceholder"),
    businessSizeOptions: t.raw("sampleBooking.businessSizeOptions") as string[],
    monthlyUsagePlaceholder: t("sampleBooking.monthlyUsagePlaceholder"),
    monthlyUsageOptions: t.raw("sampleBooking.monthlyUsageOptions") as string[],
    contactMethodOptions: t.raw("sampleBooking.contactMethodOptions") as { value: string; label: string }[],
    notesPlaceholder: t("sampleBooking.notesPlaceholder"),
