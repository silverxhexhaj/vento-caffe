          ...
          <div>
            ...
            <div className="flex flex-wrap items-center justify-start gap-3 mb-4">
              ...
              <a
                ...
                className="bg-[#25D366] text-white font-bold px-6 py-4 text-lg hover:bg-[#20bd5a] transition-colors inline-flex items-center gap-2"
              >
              ...
              <button
                ...
                className="border-2 border-white text-white font-bold px-6 py-4 text-lg hover:bg-white/10 transition-colors"
              >
