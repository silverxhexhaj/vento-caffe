...
import SampleBookingModal from "@/components/home/SampleBookingModal";
            ...
            <div className="flex flex-col gap-4">
              <div className="flex flex-col md:flex-row items-center justify-start gap-3">
                <Link 
                  ...
                  className="bg-white text-black font-bold px-8 py-4 text-lg hover:bg-white/90 transition-colors w-full md:w-auto text-center md:text-left"
                  >
                  {directOffer.ctaText}
                </Link>
                <a
                  ...
                  rel="noopener noreferrer"
                    className="bg-[#25D366] text-white font-bold px-6 py-4 text-lg hover:bg-[#20bd5a] transition-colors inline-flex items-center justify-center md:justify-start gap-2 w-full md:w-auto" 
                  >
